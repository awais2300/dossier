...
class JOTO extends CI_Controller
{
    ...
    public function view_academy_analytics()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/academy_analytics_master', $data);
        }
    }
    ...
    public function view_academic_graph()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('joto/view_academic_graph', $data);
        }
    }
    public function view_olq_graph()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('joto/view_olq_graph', $data);
        }
    }
    public function get_academic_graph()
    {
        if ($this->input->post()) {
            ...
            $view_page = $this->load->view('joto/view_academic_graph', $data, false);
            // echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function get_graph_divisionwise()
    {
        ...
        echo $data = $this->load->view('joto/academy_analytics', $data, TRUE);
    }
    ...
    public function get_semester_results_values()
    {
        if ($this->input->post()) {
            ...
            $data['gpa'] = $this->db->where('p_id', $p_id)->get('semester_results')->row_array();
            $data['cadet_data'] = $this->db->where('p_id', $p_id)->get('pn_form1s')->row_array();
            $view_page = $this->load->view('joto/view_semester_result_graph', $data, false);
            // echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_proficieny_games');
        }
    }
    ...
    public function save_proficiency_games()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('JOTO/view_proficieny_games');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('JOTO/view_proficieny_games');
            }
    ...
    public function proficiency_games_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['test_records'] = $this->db->get()->result_array();
            $html = $this->load->view('joto/proficiency_games_report', $data, TRUE); //$graph, TRUE);
