        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>DNT_S/save_cadet_result/Result">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Officer Name:</h6>
                                </div>
...
<script>
    ...
    $('#add_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            $.ajax({
                url: '<?= base_url(); ?>DNT_S/search_cadet',
                method: 'POST',
                data: {
                    'oc_no': oc_no
                },
            ...
            if ($('#officer_name').val() != '') {
                // alert($('#id').val());
                $.ajax({
                    url: '<?= base_url(); ?>DNT_S/get_semester_results_values',
                    method: 'POST',
                    data: {
                        'p_id': $('#id').val()
                    },
