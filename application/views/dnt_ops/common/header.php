...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>DNT_OPS/view_dossier_folder" aria-expanded="true">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>DNT_OPS/view_academy_analytics" aria-expanded="true">
