...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>Transfer Cadet</strong></h1>
        </div>
    ...
    <div class="card-body bg-custom3">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">Transfer Cadet</h1>
                    </div>

                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/transfer_cadet_update">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Name:</h6>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mb-1">
                                    <select class="form-control rounded-pill" name="division_name" id="division_name" data-placeholder=" Select Division" style="font-size: 0.8rem; height:50px;">
...
<script>
    ...
    $('#save_btn').on('click', function() {
        ...
        if (division_name == '') {
            validate = 1;
            $('#division_name').addClass('red-border');
        }
